  ...
  if (window.innerWidth < 768) {
    return (
      <div className="px-2 py-4">
        <div className="h-[248px] w-full lg:max-w-[420px] bg-smartphones bg-cover flex items-end">
          <h2 className="text-2xl text-white p-10 font-bold">Smartphones</h2>
        </div>
        <div className="flex space-x-2 pt-2">
          <div className="bg-accessoires bg-cover w-1/2 max-w-[420px] h-[248px]  flex items-end">
            <h2 className="text-2xl text-white pb-10  lg:p-10 pl-10 font-bold">
              Accessoires
            </h2>
          </div>
          <div className="bg-obj-con bg-cover h-[248px] max-w-[420px] w-1/2 flex items-end">
            <h2 className="text-2xl text-white pb-10 lg:p-10 pl-10 font-bold">
              Objets connectés
            </h2>
          </div>
